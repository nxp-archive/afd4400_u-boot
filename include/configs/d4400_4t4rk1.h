 ...
 *
 * Configuration settings for the Freescale D4400 4T4RK1 board.
 *
...
/* Network settings */
#define CONFIG_IPADDR		10.67.88.210
#define CONFIG_GATEWAYIP	10.67.91.254
...
#define CONFIG_EXTRA_ENV_SETTINGS\
	...
	"bootcmd_ram=echo Booting from RAM ...; run test_tftp; "\
		"run bootargs_all;tftp ${loadaddr} ${tftp_path}kernel_fit.4t4rk1.itb;"\
		"bootm ${loadaddr}\0"\
	"bootcmd=run bootcmd_qspi\0"\
	"get_fit=tftp ${loadaddr} ${tftp_path}kernel_fit.4t4rk1.itb; "\
	...
	"get_uboot1=tftp ${loadaddr} ${tftp_path}u-boot-sha256.4t4rk1.d4400; "\
		"sf probe 9:0 50000000 40;sf erase 0x0 0x80000; "\
		"sf write ${loadaddr} 0x0 ${filesize}\0 "\
	"get_uboot2=tftp ${loadaddr} ${tftp_path}u-boot-sha256.4t4rk1.d4400; "\
