...
static int force_idle_bus(void *priv)
{
	...
	d4400_iomux_setup_pad(p->sda.gpio_mode);
	d4400_iomux_setup_pad(p->scl.gpio_mode);
...
exit:
	d4400_iomux_setup_pad(p->sda.i2c_mode);
	d4400_iomux_setup_pad(p->scl.i2c_mode);
	return ret;
}
...
static void * const i2c_bases[] = {
	...
	(void *)I2C8_BASE_ADDR,
	(void *)I2C9_BASE_ADDR,
	(void *)I2C10_BASE_ADDR,
	(void *)I2C11_BASE_ADDR,
};

/* i2c_index can be from 0 - 10 */
