...
#define VETSEC_GROUP0_BASE_ADDR	(AIPS3_OFF_BASE_ADDR + 0x0000)
#define VETSEC_MDIO0_BASE_ADDR	(AIPS3_OFF_BASE_ADDR + 0x4000)
...
#define VETSEC_GROUP1_BASE_ADDR	(AIPS3_OFF_BASE_ADDR + 0x20000)
#define VETSEC_MDIO1_BASE_ADDR	(AIPS3_OFF_BASE_ADDR + 0x24000)
